...
const loadCourses=async()=>{
 ...
 setCourses(res.data.reverse());
    ...
    function deleteCourse(id) {
        axios.delete(`http://localhost:8080/courses/${id}`).then(loadCourses());
    }
        ...
        <>
            <div className="w-[100vw] h-full flex flex-col px-10 py-8 mt-8">
                <div className="flex justify-around">
                    <h2 className="text-xl font-bold">Courses Data Table</h2>
                    <button
                    ...
                    >
                        ...
                        <FaPlus size={20} color="white" /> &nbsp; Course
                    </button>
                </div>
